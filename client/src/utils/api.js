...
console.log("API request object created")
console.log("Category API created")
console.log("Special Offer API created")
console.log("Hero Slide API created")
console.log("Order API created")
console.log("Cart API created")
console.log("Review API created")
console.log("Wishlist API created")
console.log("Settings API created")
console.log("Reports API created")
console.log("Newsletter API created")
console.log("Notifications API created")
console.log("Payments API created")
console.log("Error handling function created")
console.log("File upload helper created")
console.log("Pagination helper created")
console.log("Search helper created")
...
const apiRequest = {
  ...
  forgotPassword: (email) => defaultApi.post(endpoints.auth.forgotPassword, { email }),
  ...
  verifyAdminInvitation: (token) => defaultApi.get(`/admin/verify-invitation/${token}`),

  // Users
  getProfile: () => defaultApi.get(endpoints.users.profile),
  updateProfile: (data) => defaultApi.put(endpoints.users.updateProfile, data),
  changePassword: (data) => defaultApi.post(endpoints.users.changePassword, data),
  ...
  updateProduct: (id, data) => defaultApi.put(endpoints.products.update(id), data),
  ...
  searchProducts: (query) => defaultApi.get(endpoints.products.search, { params: { q: query } }),
  ...
  updateCategory: (id, data) => defaultApi.put(endpoints.categories.update(id), data),
  ...
  createSpecialOffer: (data) => defaultApi.post(endpoints.specialOffers.create, data),
  updateSpecialOffer: (id, data) => defaultApi.put(endpoints.specialOffers.update(id), data),
  deleteSpecialOffer: (id) => defaultApi.delete(endpoints.specialOffers.delete(id)),
  getActiveSpecialOffers: () => defaultApi.get(endpoints.specialOffers.active),
  ...
  updateHeroSlide: (id, data) => defaultApi.put(endpoints.heroSlides.update(id), data),
  ...
  updateReview: (id, data) => defaultApi.put(endpoints.reviews.update(id), data),
  deleteReview: (id) => defaultApi.delete(endpoints.reviews.delete(id)),

  // Wishlist
  getWishlist: () => defaultApi.get(endpoints.wishlist.get),
  addToWishlist: (productId) => defaultApi.post(endpoints.wishlist.add, { productId }),
  removeFromWishlist: (productId) => defaultApi.delete(endpoints.wishlist.remove, { data: { productId } }),
  ...
  // Reports
  getSalesReport: (params) => defaultApi.get(endpoints.reports.sales, { params }),
  getInventoryReport: (params) => defaultApi.get(endpoints.reports.inventory, { params }),
  getCustomerReport: (params) => defaultApi.get(endpoints.reports.customers, { params }),
  getOrderReport: (params) => defaultApi.get(endpoints.reports.orders, { params }),

  // Newsletter
  subscribeToNewsletter: (data) => defaultApi.post(endpoints.newsletter.subscribe, data),
  verifyNewsletterSubscription: (token) => defaultApi.get(endpoints.newsletter.verify(token)),
  unsubscribeFromNewsletter: (token) => defaultApi.get(endpoints.newsletter.unsubscribe(token)),
  getNewsletterSubscribers: () => defaultApi.get(endpoints.newsletter.subscribers),
  ...
  markNotificationAsRead: (id) => defaultApi.patch(endpoints.notifications.markAsRead(id)),
  markAllNotificationsAsRead: () => defaultApi.patch(endpoints.notifications.markAllAsRead),
  deleteNotification: (id) => defaultApi.delete(endpoints.notifications.delete(id)),
  // Admin functions
  getAdminNotifications: () => defaultApi.get(endpoints.notifications.adminList),
  createAdminNotification: (data) => defaultApi.post(endpoints.notifications.adminCreate, data),
  createBulkAdminNotifications: (data) => defaultApi.post(endpoints.notifications.adminBulkCreate, data),
  deleteAdminNotification: (id) => defaultApi.delete(endpoints.notifications.adminDelete(id)),
  deleteAllAdminNotifications: () => defaultApi.delete(endpoints.notifications.adminDeleteAll),

  // Payments
  getPaymentMethods: () => defaultApi.get(endpoints.payments.methods),
  initializePayment: (data) => defaultApi.post(endpoints.payments.initialize, data),
  processCallback: (data) => defaultApi.post(endpoints.payments.callback, data),
  getPaymentAnalytics: (params) => defaultApi.get(endpoints.payments.analytics, { params }),
...
export const specialOfferAPI = {
  ...
  update: (id, data) => defaultApi.put(endpoints.specialOffers.update(id), data),
...
export const wishlistAPI = {
  ...
  add: (productId) => defaultApi.post(endpoints.wishlist.add, { productId }),
  remove: (productId) => defaultApi.delete(endpoints.wishlist.remove, { data: { productId } }),
}
...
export const reportsAPI = {
  ...
  getInventory: (params) => defaultApi.get(endpoints.reports.inventory, { params }),
  getCustomers: (params) => defaultApi.get(endpoints.reports.customers, { params }),
...
export const newsletterAPI = {
  ...
  unsubscribe: (token) => defaultApi.get(endpoints.newsletter.unsubscribe(token)),
...
export const notificationAPI = {
  ...
  markAllAsRead: (type) => defaultApi.patch(endpoints.notifications.markAllAsRead, { type }),
  delete: (id) => defaultApi.delete(endpoints.notifications.delete(id)),
  getUnreadCount: (type) => defaultApi.get(endpoints.notifications.unreadCount, { params: { type } }),
  getStats: () => defaultApi.get(endpoints.notifications.stats),
  // Admin functions
  getAdminList: (params) => defaultApi.get(endpoints.notifications.adminList, { params }),
  createAdmin: (data) => defaultApi.post(endpoints.notifications.adminCreate, data),
  getAdminStats: () => defaultApi.get(endpoints.notifications.adminStats),
  deleteAdmin: (id) => defaultApi.delete(endpoints.notifications.adminDelete(id)),
  deleteAllAdmin: () => defaultApi.delete(endpoints.notifications.adminDeleteAll),
  retryDelivery: () => defaultApi.post(endpoints.notifications.adminRetryDelivery),
}
...
export const paymentAPI = {
  ...
  processCallback: (data) => defaultApi.post(endpoints.payments.callback, data),
  getAnalytics: (params) => defaultApi.get(endpoints.payments.analytics, { params }),
